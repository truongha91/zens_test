            ...
            <Layout className="block-layout">
                ...
                <Footer style={{textAlign: 'center'}}>
                    <div className="block-footer">
                        ...
                        <p>information only and do not constitute any form of advice. HLS assumes no responsibility for
                            the accuracy of any particular statement and</p>
                        <p>accepts no liability for any loss or damage which may arise from reliance on the information
